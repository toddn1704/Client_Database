...
def update_vol(vol_id, firstname, lastname, phonenum, active_state, color=None):
...
def generate_custom_report(start, end):
        """This function will generate a csv/excel file for a
        given time frame.
        """
        generate_custom(s, start, end)
